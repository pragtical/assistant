...
test.describe("assistant ACP backend", function()
  ...
  test.it("records Copilot ACP thoughts and tool activity in the transcript", function()
    ...
    test.equal(md:find("Path: project/main.c", 1, true) ~= nil, true)
    test.equal(md:find("Status: completed", 1, true) ~= nil, true)
  end)
  ...
  test.it("records failed Copilot ACP tool update messages", function()
    ...
    test.equal(md:find("Status: failed", 1, true) ~= nil, true)
    test.equal(md:find("Message: The user rejected this tool call.", 1, true) ~= nil, true)
    test.equal(md:find("Code: rejected", 1, true) ~= nil, true)
  end)
